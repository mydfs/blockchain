...
contract('MyDFSToken', function(accounts){
	...
	it("should send coin correctly", async function() {
    	...
    	var one_starting_balance = await token.balanceOf(account_one);
    	var two_starting_balance = await token.balanceOf(account_two);
    	
    	await token.transfer(account_two, amount, {from: account_one});
    	
    	var one_ending_balance = await token.balanceOf(account_one);
    	var two_ending_balance = await token.balanceOf(account_two);
	...
	it("should increase allowance correctly", async function() {
    	...
    	var allowance = await token.allowance(account_one, account_two);
